...
var _ = __m8,
	...
	utils = __m4,
	MESSAGE_TYPE = __m5.WORKER_PROVIDER_MESSAGE_TYPE;
...
var _ = __m8,
	...
	EventEmitter = __m3.EventEmitter,
	utils = __m4,
	MESSAGE_TYPE = __m5.MONITOR_MESSAGE_TYPE;
...
var getApi = function(){
	...
	api.workerProviders = this.workerProviders;
...
Monitor.prototype.newWorkerProvider = function(workerProviderConfig){
	...
	workerProvider.on("update", function(){
		self.emitter.emit("update");
	});
...
Monitor.prototype.workerProviderMessage = function(workerProviderId, message){
	...
	workerProvider.messageHandler(message);
};
